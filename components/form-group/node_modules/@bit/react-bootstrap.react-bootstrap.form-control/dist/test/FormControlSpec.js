...
describe('<FormControl>', function () {
  it('should render correctly', function () {
    (0, _enzyme.mount)(_react.default.createElement(_FormControl.default, {
      type: "text",
      id: "foo",
      name: "bar",
  ...
  it('should support type=file', function () {
    (0, _enzyme.mount)(_react.default.createElement(_FormControl.default, {
      type: "file"
    })).assertSingle('[type="file"].form-control-file').assertNone('.form-control');
  });
  it('should support plaintext inputs', function () {
    (0, _enzyme.mount)(_react.default.createElement(_FormControl.default, {
      plaintext: true
    })).assertSingle('input.form-control-plaintext');
  });
  it('should use controlId for id', function () {
    (0, _enzyme.mount)(_react.default.createElement(_FormGroup.default, {
      controlId: "foo"
    }, _react.default.createElement(_FormControl.default, {
      type: "text"
    }))).assertSingle('input#foo.form-control');
  });
  it('should prefer explicit id', function () {
    (0, _helpers.shouldWarn)('ignored');
    (0, _enzyme.mount)(_react.default.createElement(_FormGroup.default, {
      controlId: "foo"
    }, _react.default.createElement(_FormControl.default, {
      type: "text",
  ...
  it('should properly display size of FormControl', function () {
    (0, _enzyme.mount)(_react.default.createElement(_FormControl.default, {
      type: "text",
      size: "lg"
    })).assertSingle('input.form-control.form-control-lg');
  });
});

//# sourceMappingURL=FormControlSpec.js.map